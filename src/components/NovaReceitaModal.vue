                ...
                <form @submit.prevent="submitForm">
                    <div class="modal-body py-3">
                        ...
                        <div class="form-check mt-2">
                            ...
                            <input class="form-check-input" type="checkbox" v-model="receita.contemAlergicos" id="contemAlergicosCheckbox" @change="toggleAlergicos()">
                        </div>
                        ...
                        <div v-if="receita.contemAlergicos">
                            ...
                            <div v-for="(alergico, indexAlergico) in receita.alergicos" class="mt-2" :key="indexAlergico">
                                <div class="d-flex align-items-center gap-2">
                                <input class="form-control" v-model="receita.alergicos[indexAlergico]" id="alergico" type="text" required>
