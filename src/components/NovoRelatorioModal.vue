...
const submitForm = (async () => {
    ...
    await api.post('/relatorios/novo', relatorio )
    .then (() => {
...
<template>
    <div class="modal fade" :id="'novoRelatorioModal' + paciente.id" tabindex="-1" aria-labelledby="novoRelatorioModalLabel"
        aria-hidden="true">
                    ...
                    <div class="modal-body py-4">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" v-model="relatorio.dataConsulta" id="dataConsulta" type="date" required>
                            </div>
                        </div>
                        ...
                        <div v-for="(medicao, index) in relatorio.medicoes" class="mt-2" :key="index">
                            <div class="input-group">
                                ...
                                <div class="btn btn-danger" @click="removerMedicao(index)"><i class="bi bi-trash-fill"></i></div>
                            </div>
                        </div>
                    </div>
